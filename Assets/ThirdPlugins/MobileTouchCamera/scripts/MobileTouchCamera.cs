...
namespace BitBenderGames
{
    ...
    public class MobileTouchCamera : MonoBehaviourWrapped
    {
        ...
        private CameraPlaneAxes cameraAxes = CameraPlaneAxes.XZ_TOP_DOWN;
        [SerializeField]
...
#pragma warning disable 414 //NOTE: This field is actually used by the custom inspector. The pragma disables the warning that appears because the variable isn't accessed directly, but only through reflection.
        private AutoScrollDampMode autoScrollDampMode = AutoScrollDampMode.CUSTOM;
#pragma warning restore 414
        ...
        private float autoScrollDamp = 160;
        [SerializeField]
...
#pragma warning restore 649
        ...
        private bool enableMouseScroll = true;  //是否允许鼠标滚轮
        #endregion
...
#pragma warning restore 162
        ...
        private bool isInvokingSetCrameraPositionGoon;
        private CallBack setCrameraPositionGoon;

        public CallBack SetCrameraPositionGoon
        {
            get { return setCrameraPositionGoon; }
            set { setCrameraPositionGoon = value; }
        }

        private CallBack lateUpdateGoon;

        public CallBack LateUpdateGoon
        {
            set { lateUpdateGoon = value; }
        }
        ...
        private CallBack OnAutoMoveDone;
        ...
        private bool _changeCamFarPos = false;
        private float _saveFarPos;
        private float _saveZoomMax;
        public void AutoLookAt(Vector3 target, float zoom = 0, float _time = 0, CallBack handle = null)
        {
            //这里限制了速度
            aotoMove = false;
        ...
        public void LookAt(Vector3 target)
        {
            ...
            if (!isInvokingSetCrameraPositionGoon)
            {
                isInvokingSetCrameraPositionGoon = true;
                SetCrameraPositionGoon?.Invoke();
                isInvokingSetCrameraPositionGoon = false;
            }
        }

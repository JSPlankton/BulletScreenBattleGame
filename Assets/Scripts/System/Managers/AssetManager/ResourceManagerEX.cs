...
{
	private static ResourceManagerEX resourceManagerEX = null;

	private AssetLoader m_assetLoader = new AssetLoader();
	private ResourcesLoader m_resourceLoader = new ResourcesLoader();

	public static ResourceManagerEX GetInstance()
	{
		if (resourceManagerEX == null)
		{
			resourceManagerEX = new ResourceManagerEX();
		}
		return resourceManagerEX;
	}

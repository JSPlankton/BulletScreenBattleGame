...
public static class ParseTool  
{
    ...
    private  static string Array2String(object value, char[] arraySplitFormat, int charTagIndex)
    {
        ...
        {
            LogUtil.Exception("charTagIndex:" + charTagIndex + " arraySplitFormat:" + arraySplitFormat.Length + " value:" + value.GetType(), e);
            return result;
        }
    ...
    private static object CreateInterleavedArray(string value, Type elementType, int num, char[] arraySplitFormat,int charTagIndex)
    {
        ...
        for (int i = 0; i <arrayLenth; i++)
        {
            ...
            //LogUtil.Log(" tempStr：" + tempStr+ " arrayType:"+ arrayType+" i:"+ i+ " childValue:"+ childValue.GetType()+" Lenth:"+ instance.Length);
            try
            {
            ...
            {
                LogUtil.Error(instance.GetType()+ " instance.Length:"+ instance.Length+ " childValue.GetType():"+ childValue.GetType()+ "\n" + e);
            }
        }
        return instance;
    }
    ...
    public static object String2SingleObject(Type type,string value)
    {
        ...
        {
            LogUtil.Error("不支持的数据类型：" + type.FullName + " value:" + value);
        }
        return null;
    }
   ...
   public static string GetString(string content)
    ...
    public static Type CreateInterleavedType(Type elementType,int num)
    {
        //if (num <= 0)
        //{
        //    LogUtil.Error("num need greater 0");
        //    return null;
        //}

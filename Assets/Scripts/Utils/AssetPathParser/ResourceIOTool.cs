...
public class ResourceIOTool :MonoBehaviour
{
    ...
    public static string ReadStringByFile(string path)
    {
        ...
        try
        {
            if (!File.Exists(path))
            {
                LogUtil.Log("path dont exists ! : " + path);
                return "";
            }
        ...
        {
            LogUtil.Error("Load text fail ! message:" + e.Message);
        }
    ...
    public static string ReadStringByResource(string path)
    {
        ...
        TextAsset text;
#if UNITY_EDITOR
        text = UnityEditor.AssetDatabase.LoadAssetAtPath<TextAsset>(LoadPathUtil.GetPathForLocalFile(path));
    ...
    public static byte[] ReadBytesByResource(string path)
    {
        TextAsset text;
#if UNITY_EDITOR
        text = UnityEditor.AssetDatabase.LoadAssetAtPath<TextAsset>(LoadPathUtil.GetPathForLocalFile(path));
    ...
    //    {
    //        LogUtil.Error("LoadWWW Error URL: ->" + url + "<- error: " + www.error);
    //    }
    //}
    ...
    public static void DeleteFile(string path)
    {
        ...
        {
            LogUtil.Log("File:[" + path + "] dont exists");
        }
    }
    ...
    public static void CreateFile(string path, byte[] byt)
    {
        ...
        {
            LogUtil.Error("File Create Fail! \n" + e.Message);
        }
    }
